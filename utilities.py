...
def create_pdf_from_text(text, title="Cover Letter"):
    ...
    doc = SimpleDocTemplate(buffer, pagesize=letter,
                            ...
                            topMargin=36, bottomMargin=18,title="Cover Letter Nikhil",
        author="Nikhil Kulkarni")  # Reduced top margin
    
    styles = getSampleStyleSheet()
    styles.add(ParagraphStyle(name='Justify', alignment=TA_JUSTIFY, fontSize=12))  # Increased font size
